"""
This script is used to trained Xception, InceptionResNetV2 on 299x299 image. 
Simple augmentation + [Mixup or Cutmix] (see below) is used for training and 
...
## If training Xception, use first line. If training InceptionResNetV2, use second line, etc.
SAVE_NAME = 'fold0_[Xception-299]_aug2'
# SAVE_NAME = 'fold0_[InceptionResNetV2-299]_aug2'
