"""
This script is used to trained InceptionResNetV2 with Focal Loss on 299x299 image. 
...
# Credits: https://github.com/umbertogriffo/focal-loss-keras/blob/master/losses.py
...
class NetModel():
    ...
    def create_model(self):
        ...
        model.compile(optimizer=tf.keras.optimizers.Adam(), 
                      loss=[categorical_focal_loss(alpha=.25, gamma=2)], metrics=['acc'])
        return model
...
SAVE_NAME = 'fold0_[InceptionResNetV2-299-[focal_g2_a.25]]_aug'
